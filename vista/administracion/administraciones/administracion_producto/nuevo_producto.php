...
$sql=mysqli_query($conexion, "select permiso_insertar from tbl_ms_permisos where id_rol='$id_rol' and id_objeto=7");
$row=mysqli_fetch_array($sql);
$permiso=$row[0];
...
<br></br><br></br>
    <!--INICIO DEL FORM REGISTRO USUARIOS-->
        <form class="col-3 p-2 m-auto" method="POST" autocomplete="off">
            <img src="../../../../public/img/nuevo_producto.jpg" class="img-fluid rounded mx-auto d-block"/>
