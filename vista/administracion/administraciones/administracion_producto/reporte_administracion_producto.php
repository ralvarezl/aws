...
function Header()
{
    ...
    $this->Ln(10);
    $this->Cell(195,10,'Reporte de Producto',0,0,'C');
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Producto', 'Genero reporte de producto','$sesion_usuario')");
