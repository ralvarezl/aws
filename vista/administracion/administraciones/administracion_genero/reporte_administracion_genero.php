...
function Header()
{
    ...
    $this->Ln(10);
    $this->Cell(210,10,'Reporte Genero',0,0,'C');
...
//Llamo a la BD
require ('../../../../modelo/conexion.php');
$consulta = "select id_genero, genero, estado from tbl_ms_genero order by id_genero asc";
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Genero', 'Genero reporte de genero','$sesion_usuario')");
