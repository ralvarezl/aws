...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#" >
                <i class="fas fa-venus-mars"></i> ADMINISTRACION ESTADO
            </a>
    ...
    <?php 
            ...
            $busqueda_genero = strtoupper($_REQUEST['busqueda_genero']);
    ?>
    <div class="container-fluid row">
        <div class="col-8 p-4 m-auto">
            ...
            include "../../../../controlador/administraciones/eliminar_genero.php";
            ?>  
            <div class="row p-2"> <!--Div que contiene nuevo genero y la busqueda-->
                <div class="ml-auto p-2">
                    <button type="button" class="btn btn-dark" onclick="location.href='nuevo_genero.php'" >Nuevo Genero</button>
                </div>
                    
                <!--BUSQUEDA, al apretar el boton buscar que me envie a buscar_genero-->
                <div class="align-items-end">
                    <form action="buscar_genero.php" method="get" class="form_search">
                        <input type="text" name="busqueda_genero" id="busqueda_genero" placeholder="" value="<?php echo $busqueda_genero; ?>">
                        <a class="fa-sharp fa-solid fa-rotate-right btn btn-lg btn-secondary" href="administracion_genero.php"></a>
                        <input type="submit" value="Buscar" class="btn btn-secondary">
                        <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_buscar_genero.php"></a>
                    </form>
                </div>
            </div>
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return eliminar()" href="administracion_genero.php?id_genero=<?= $u['id_genero'] ?>" class="btn btn-small btn-danger" name="btnborrar_genero"><i class="fa-solid fa-trash-can"></i></a>
                        </td>
                    </tr>
                    <?php }
                    $_SESSION['busqueda_genero'] = $busqueda_genero;
                    ?>
                </tbody>
            </table>
