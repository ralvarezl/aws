...
while ($row = $resultado->fetch_assoc()) {
    // Movernos a la derecha
    $pdf->Cell(20);
    $pdf->Cell(55, 10,utf8_decode( $row['fecha_bitacora']), 1, 0, 'C', 0);
    $pdf->Cell(40, 10,utf8_decode( $row['accion']), 1, 0, 'C', 0);
    $pdf->Cell(65, 10,utf8_decode( $row['descripcion']), 1, 0, 'C', 0);
    $pdf->Cell(55, 10,utf8_decode( $row['creado_por']), 1, 1, 'C', 0); //En la ultima celda le digo que haga un salto de linea
}
