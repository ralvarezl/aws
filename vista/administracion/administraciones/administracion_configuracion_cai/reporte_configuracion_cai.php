...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Configuracion Cai', 'Genero reporte de configuracion cai','$sesion_usuario')");
?>