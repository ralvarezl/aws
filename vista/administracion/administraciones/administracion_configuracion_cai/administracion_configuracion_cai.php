    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <div class="offcanvas-body">
                ...
                <li class="btn btn-dark p-2">
                    <a class="nav-link" href="#"><i class="fa-solid fa-gears"></i> ADMINISTRADOR DE CONFIGURACION CAI</a>
                </li>

                <li class="btn btn-dark p-2">
                    <a class="nav-link" href="../administracion_descuento/administracion_descuento.php"><i class="fa-solid fa-users-gear"></i> ADMINISTRADOR DE DESCUENTO</a>
                </li>
        ...
        <!--BUSQUEDA, al apretar el boton buscar que me envie a buscar_configuracion_cai-->
        <div class="ml-auto p-2">
            <form action="buscar_configuracion_cai.php" method="get" class="form_search">
            <input type="text" name="busqueda_configuracion_cai" id="busqueda_configuracion_cai" placeholder="">
            <input type="submit" value="Buscar" class="btn btn-secondary">
            <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_configuracion_cai.php"></a>
            </form>
        </div>
