...
<head>
    ...
    <title>Administración Sucursal</title>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#" >
                <i class="fa-solid fa-users-gear"></i> ADMINISTRACIÓN DE SUCURSAL
            </a>
            ...
            <div class="offcanvas-body">
                ...
                <li class="btn btn-dark p-2">
                    <a class="nav-link" href="../../../../controlador/bitacora_pantalla/admin_tipo_pedido.php"><i class="fas fa-poll-h"></i> ADMINISTRADOR DE PEDIDOS</a>
                </li>
                <!--ADMINISTRADOR DE SUCURSAL-->
                <li class="btn btn-dark p-2">
                    <a class="nav-link" href="#"><i class="fas fa-store-alt"></i> ADMINISTRADOR DE SUCURSAL</a>
                </li>
    ...
    <div class="container-fluid row">
        <div class="col-8 p-4 m-auto">
            ...
            include "../../../../controlador/administraciones/eliminar_sucursal.php";
            ?>  
            <div class="row p-2"> <!--Div que contiene nueva sucursal y la busqueda-->
                <div class="ml-auto p-2">
                    <button type="button" class="btn btn-dark" onclick="location.href='nueva_sucursal.php'" >Nuevo Sucursal</button>
                </div>
                ...
                <div class="align-items-end">
                    <form action="buscar_sucursal.php" method="get" class="form_search">
                        <input type="text" name="busqueda_sucursal" id="busqueda_sucursal" placeholder="">
                        <input type="submit" value="Buscar" class="btn btn-secondary">
                        <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_administracion_sucursal.php"></a>
                    </form>
                </div>
            </div>
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return eliminar()" href="administracion_sucursal.php?id_sucursal=<?= $u['id_sucursal'] ?>" class="btn btn-small btn-danger" name="btnborrar_sucursal"><i class="fa-solid fa-trash-can"></i></a>
                        </td>
                    </tr>
                    <?php }
                    ?>
