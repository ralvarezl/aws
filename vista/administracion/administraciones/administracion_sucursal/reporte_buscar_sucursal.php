...
//Llamo a la BD
require ('../../../../modelo/conexion.php');
$busqueda_sucursal=$_SESSION['busqueda_sucursal'];
$consulta = "select id_sucursal, nombre, direccion, estado from tbl_sucursal
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Sucursal', 'Genero reporte especifico de sucursal','$sesion_usuario')");
