...
<body>
    ...
    <!--INICIO DE LA TABLE SUCURSAL-->
        <?php 
            ...
            $busqueda_sucursal = strtoupper($_REQUEST['busqueda_sucursal']);
        ?>
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return eliminar()" a href="administracion_sucursal.php?id_sucursal=<?= $u['id_sucursal'] ?>" class="btn btn-small btn-danger" name="btnborrar"><i class="fa-solid fa-trash-can"></i></a>
                        </td>
                    </tr>
                    <?php }
                    $_SESSION['busqueda_sucursal'] = $busqueda_sucursal;
                    ?>
                </tbody>
            </table>
