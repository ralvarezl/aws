...
<head>
    ...
    <title>Administracion Descuentos</title>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        ...
        $busqueda_descuento = strtoupper($_REQUEST['busqueda_descuento']);
        ...
        <div class="ml-auto p-2">
            ...
            <input type="text" name="busqueda_descuento" id="busqueda_descuento" placeholder="" value="<?php echo $busqueda_descuento; ?>">
            <input type="submit" value="Buscar" class="btn btn-secondary">
            <a class="fa-sharp fa-solid fa-rotate-right btn btn-lg btn-secondary" href="administracion_descuento.php"></a>
            <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_buscar_descuento.php"></a>
            </form>
        </div>
                ...
                ?>
                    <table class="table table-dark table-striped" style="text-align:center;" >
                        ...
                        <tbody>
                            ...
                            $_SESSION['busqueda_descuento'] = $busqueda_descuento;
                            ?>
                        </tbody>
                    </table>
