...
$sql=mysqli_query($conexion, "select permiso_visualizar from tbl_ms_permisos where id_rol='$id_rol' and id_objeto=12");
$row=mysqli_fetch_array($sql);
if(is_null($row)){
        ...
        <div class="col-8 p-4 m-auto">
            ...
            <div class="row p-2"> <!--Div que contiene nueva sucursal y la busqueda-->
                ...
                <div class="align-items-end">
                    <form action="buscar_sucursal_promocion.php" method="get" class="form_search">
                        <input type="text" name="busqueda_sucursal_promocion" id="busqueda_sucursal_promocion" placeholder="">
                        <input type="submit" value="Buscar" class="btn btn-secondary">
                        <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_administracion_sucursal_promocion.php"></a>
                    </form>
                </div>
            </div>
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    include "../../../../modelo/conexion.php";
                    $sql=$conexion->query("select id_sucursal, id_promocion, estado from tbl_sucursal_promocion order by id_sucursal asc");
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="actualizar_sucursal_promocion.php?id_sucursal=<?= $u['id_sucursal'] ?>" class="btn btn-small btn-warning" name="btnactualizar"><i class="fa-solid fa-user-pen"></i></a>
                        </td>
                    </tr>
                    <?php }
                    ?>
