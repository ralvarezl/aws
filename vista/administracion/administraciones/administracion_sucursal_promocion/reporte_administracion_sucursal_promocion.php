...
//Llamo a la BD
require ('../../../../modelo/conexion.php');
$consulta = "select id_sucursal, id_promocion, estado from tbl_sucursal_promocion order by id_sucursal asc";
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Sucursal Promocion', 'Genero reporte de sucursal promocion','$sesion_usuario')");
