...
//Llamo a la BD
require ('../../../../modelo/conexion.php');
$busqueda_sucursal_promocion=$_SESSION['busqueda_sucursal_promocion'];
$consulta = "select id_sucursal, id_promocion, estado from tbl_sucursal_promocion
...
while ($row = $resultado->fetch_assoc()) {
    // Movernos a la derecha
    $pdf->Cell(20);
    $pdf->Cell(55, 10,utf8_decode( $row['id_sucursal']), 1, 0, 'C', 0);
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Sucursal Promocion', 'Genero reporte especifico de sucursal promocion','$sesion_usuario')");
