...
function Header()
{
    ...
    $this->Ln(10);
    $this->Cell(210,10,'Reporte de Promocion',0,0,'C');
    // Salto de línea
    $this->Ln(35);
}
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Promocion', 'Genero reporte de promocion','$sesion_usuario')");
