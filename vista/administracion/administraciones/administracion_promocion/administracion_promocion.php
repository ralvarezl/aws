...
$sql=mysqli_query($conexion, "select permiso_visualizar from tbl_ms_permisos where id_rol='$id_rol' and id_objeto=8");
$row=mysqli_fetch_array($sql);
if(is_null($row)){
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#" >
                <i class="fas fa-tags"></i> ADMINISTRACIÓN DE PROMOCIÓN
            </a>
