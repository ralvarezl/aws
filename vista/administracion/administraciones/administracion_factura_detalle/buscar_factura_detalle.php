...
<body>
    ...
    $busqueda_factura_detalle = strtoupper($_REQUEST['busqueda_factura_detalle']);
    ?>
        ...
        <div class="col-8 p-4 m-auto">
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    where id_factura_detalle like '%$busqueda_factura_detalle%' or
                            nombre like '%$busqueda_factura_detalle%' or
                            d.precio like '%$busqueda_factura_detalle%' or 
                            d.cantidad like '%$busqueda_factura_detalle%' or
                            total like '%$busqueda_factura_detalle%' or
                            descripcion like '%$busqueda_factura_detalle%' or
                            d.estado like '%$busqueda_factura_detalle%' 
