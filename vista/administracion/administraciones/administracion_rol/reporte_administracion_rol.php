...
function Header()
{
    ...
    $this->Ln(10);
    $this->Cell(210,10,'Reporte Roles',0,0,'C');
    // Salto de línea
    $this->Ln(35);
}
...
//Llamo a la BD
require ('../../../../modelo/conexion.php');
$consulta = "select id_rol, rol, descripcion from tbl_ms_roles order by id_rol asc";
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Roles', 'Genero reporte de roles','$sesion_usuario')");
