...
$sql=mysqli_query($conexion, "select permiso_visualizar from tbl_ms_permisos where id_rol='$id_rol' and id_objeto=15");
$row=mysqli_fetch_array($sql);
if(is_null($row)){
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#" >
                <i class="fas fa-user-tie"></i> ADMINISTRACION ROLES
            </a>
        ...
        <div class="col-8 p-4 m-auto">
            ...
            <div class="row p-2"> <!--Div que contiene nuevo rol y la busqueda-->
                ...
                <div class="align-items-end">
                    <form action="buscar_rol.php" method="get" class="form_search">
                        <input type="text" name="busqueda_rol" id="busqueda_rol" placeholder="">
                        <input type="submit" value="Buscar" class="btn btn-secondary">
                        <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_administracion_rol.php"></a>
                    </form>
                </div>
            </div>
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    include "../../../../modelo/conexion.php";
                    $sql=$conexion->query("select id_rol, rol, descripcion, estado_rol from tbl_ms_roles order by id_rol asc");
                    $numero=0;
