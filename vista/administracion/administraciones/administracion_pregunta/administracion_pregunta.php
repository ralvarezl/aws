...
$sql=mysqli_query($conexion, "select permiso_visualizar from tbl_ms_permisos where id_rol='$id_rol' and id_objeto=19");
$row=mysqli_fetch_array($sql);
if(is_null($row)){
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#" >
                 <i class="fas fa-question-circle"></i> ADMINISTRACION PREGUNTAS
            </a>
            ...
            <div class="row p-2"> <!--Div que contiene nueva pregunta y la busqueda-->
                ...
                <div class="align-items-end">
                    <form action="buscar_pregunta.php" method="get" class="form_search">
                        <input type="text" name="busqueda_pregunta" id="busqueda_pregunta" placeholder="">
                        <input type="submit" value="Buscar" class="btn btn-secondary">
                        <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_administracion_pregunta.php"></a>
                    </form>
                </div>
            </div>
