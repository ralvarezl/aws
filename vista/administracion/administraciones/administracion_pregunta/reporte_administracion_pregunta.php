...
//Llamo a la BD
require ('../../../../modelo/conexion.php');
$consulta = "select id_pregunta, pregunta from tbl_ms_preguntas order by id_pregunta asc";
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Preguntas', 'Genero reporte de preguntas','$sesion_usuario')");
