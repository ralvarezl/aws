...
function Header()
{
    ...
    $this->Ln(10);
    $this->Cell(210,10,'Reporte Estado',0,0,'C');
...
//Llamo a la BD
require ('../../../../modelo/conexion.php');
$consulta = "select id_estado, estado, estado1 from tbl_ms_estado order by id_estado asc";
...
$sql_bitacora=$conexion->query("INSERT INTO tbl_ms_bitacora (fecha_bitacora, accion, descripcion,creado_por) value ( '$fecha', 'Reporte Estado', 'Genero reporte de estado','$sesion_usuario')");
