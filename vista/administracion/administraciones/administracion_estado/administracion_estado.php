...
$sql=mysqli_query($conexion, "select permiso_visualizar from tbl_ms_permisos where id_rol='$id_rol' and id_objeto=20");
$row=mysqli_fetch_array($sql);
if(is_null($row)){
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#" >
                  <i class="fas fa-toggle-on"></i> ADMINISTRACION ESTADO
            </a>
        ...
        <div class="col-8 p-4 m-auto">
            ...
            <div class="row p-2"> <!--Div que contiene nuevo estado y la busqueda-->
                ...
                <div class="align-items-end">
                    <form action="buscar_estado.php" method="get" class="form_search">
                        <input type="text" name="busqueda_estado" id="busqueda_estado" placeholder="">
                        <input type="submit" value="Buscar" class="btn btn-secondary">
                        <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_administracion_estado.php"></a>
                    </form>
                </div>
            </div>
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    include "../../../../modelo/conexion.php";
                    $sql=$conexion->query("select id_estado, estado, estado1 from tbl_ms_estado order by id_estado asc");
                    $numero=0;
                    while($u = $sql->fetch_assoc()){ ?>
                    <tr>
                        <td><?php echo $numero=$numero+1; ?></td>
                        <td><?php echo $u['estado']; ?></td>
                        <td><?php echo $u['estado1']; ?></td>
                        <td>
