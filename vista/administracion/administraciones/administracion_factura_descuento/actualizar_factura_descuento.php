...
$sql=mysqli_query($conexion, "select permiso_actualizar from tbl_ms_permisos where id_rol='$id_rol' and id_objeto=17");
$row=mysqli_fetch_array($sql);
$permiso=$row[0];
...
<body>
        ...
        <form class="col-3 p-2 m-auto" method="POST" autocomplete="off">
            <img src="../../../../public/img/actualizar_factura_des.png" class="img-fluid rounded mx-auto d-block"/>
