...
$sql=mysqli_query($conexion, "select permiso_visualizar from tbl_ms_permisos where id_rol='$id_rol' and id_objeto=14");
$row=mysqli_fetch_array($sql);
if(is_null($row)){
        ...
        <div class="col-8 p-4 m-auto">
            ...
            <div class="row p-2"> <!--Div que contiene nuevo objeto y la busqueda-->
                ...
                <div class="align-items-end">
                    <form action="buscar_objeto.php" method="get" class="form_search">
                        <input type="text" name="busqueda_objeto" id="busqueda_objeto" placeholder="">
                        <input type="submit" value="Buscar" class="btn btn-secondary">
                        <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_administracion_objeto.php"></a>
                    </form>
                </div>
            </div>
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    include "../../../../modelo/conexion.php";
                    $sql=$conexion->query("select id_objeto, objeto, descripcion, tipo_objeto, estado from tbl_ms_objetos order by id_objeto asc");
                    $numero=0;
