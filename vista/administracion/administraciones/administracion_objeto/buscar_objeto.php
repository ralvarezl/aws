...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#" >
                <i class="fa-solid fa-users-gear"></i> ADMINISTRACION OBJETOS
            </a>
    ...
    $busqueda_objeto = strtoupper($_REQUEST['busqueda_objeto']);
    ?>
    <div class="container-fluid row">
        <div class="col-8 p-4 m-auto">
            ...
            include "../../../../controlador/administraciones/eliminar_objeto.php";
            ?>  
            <div class="row p-2"> <!--Div que contiene nuevo objeto y la busqueda-->
                <div class="ml-auto p-2">
                    <button type="button" class="btn btn-dark" onclick="location.href='nuevo_objeto.php'" >Nuevo Objeto</button>
                </div>
                    
                <!--BUSQUEDA, al apretar el boton buscar que me envie a buscar_objeto-->
                <div class="align-items-end">
                    <form action="buscar_objeto.php" method="get" class="form_search">
                        <input type="text" name="busqueda_objeto" id="busqueda_objeto" placeholder="" value="<?php echo $busqueda_objeto; ?>">
                        <a class="fa-sharp fa-solid fa-rotate-right btn btn-lg btn-secondary" href="administracion_objeto.php"></a>
                        <input type="submit" value="Buscar" class="btn btn-secondary">
                        <a class="fa-solid fa-file-pdf btn btn-lg btn-danger" href="reporte_buscar_objeto.php"></a>
                    </form>
                </div>
            </div>
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return eliminar()" href="administracion_objeto.php?id_objeto=<?= $u['id_objeto'] ?>" class="btn btn-small btn-danger" name="btnborrar_objeto"><i class="fa-solid fa-trash-can"></i></a>
                        </td>
                    </tr>
                    <?php }
                    $_SESSION['busqueda_objeto'] = $busqueda_objeto;
                    ?>
                </tbody>
            </table>
