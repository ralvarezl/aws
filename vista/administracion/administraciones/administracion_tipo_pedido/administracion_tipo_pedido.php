...
<head>
    ...
    <title>Administracion Tipo Pedido</title>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="#" >
                <i class="fa-solid fa-gears"></i> ADMINISTRACION DE TIPO DE PEDIDO
            </a>
            ...
            <div class="offcanvas-body">
                ...
                <li class="btn btn-dark p-2">
                    <a class="nav-link" href=""><i class="fa-solid fa-gears"></i> ADMINISTRADOR DE PEDIDOS</a>
                </li>
