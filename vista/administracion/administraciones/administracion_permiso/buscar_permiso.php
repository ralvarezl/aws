        ...
        <div class="col-8 p-4 m-auto">
            ...
            <table class="table table-dark table-striped" style="text-align:center; white-space: nowrap; overflow: auto;">
                ...
                <tbody>
                    ...
                    include "../../../../modelo/conexion.php";
                    $sql=$conexion->query("select p.id_rol, p.id_objeto, rol, objeto, permiso_visualizar, permiso_insertar, permiso_actualizar, permiso_eliminar from tbl_ms_permisos p inner join tbl_ms_roles r on r.id_rol=p.id_rol inner join tbl_ms_objetos o on o.id_objeto=p.id_objeto
                     where  rol like '%$busqueda_permiso%' and r.id_rol<>4 or
                            ...
                            permiso_eliminar like '%$busqueda_permiso%' and r.id_rol<>4
                    order by id_rol");
                    $num=0;
