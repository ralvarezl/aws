<?php
    if(!empty($_GET["id_rol"])) {
        ...
        if($permiso <> 'PERMITIR'){
            ...
            $sql=$conexion->query(" delete from tbl_ms_permisos where id_rol=$id_rol and id_objeto=$id_objeto");
            if ($sql==1) {
                //Guardar la bitacora 
                ...
                echo '<script language="javascript">alert("Permiso eliminado correctamente");</script>';//factura inactivado
            } else {
