                    ...
                    if($validar==true){
                        ...
                        if($validar==true){
                            if ($datos=$sql -> fetch_object()){ 
                                ...
                                $titulo="Andres Coffee-Recuperacion de Contraseña";  
                                $asunto="Solicitud de restablecimiento de contraseña";
                                $bodyphp="<div class='form-container'><form>Hola, <b>". $usuario.".</b> <br/><br/> <b>Estas recibiendo este correo porque hiciste una solicitud de recuperación de contraseña para tu usuario.</b><br/><br/><br/> Por los momentos tu token es: <b>".$token."</b><br/> El siguiente paso es entrar a la página principal y cambiarla por una más fácil de recordar para ti.<br/>Saludos, ". $usuario ."<br/></br><br/><br/> <div align='center'><h1>Andres Coffee</h1><h4>La Paz, La Paz, Honduras</h4></div></form></div>";
